...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        {
            // calculate rotations
            var rotationChanges = _aimbot.TrackTarget();

            // add to horizontal rotation
            transform.Rotate(rotationChanges.TurnAddition);

            // add to vertical rotation
            _cinemachineTargetPitch += rotationChanges.PitchAdditionInDegrees;
